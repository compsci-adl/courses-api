...
def setup_logger():
    ...
    if not logger.hasHandlers():    
        ...
        debug_file_handler = logging.FileHandler(debug_log_file_path, mode='w', delay=True)
        debug_file_handler.setLevel

        # Setup error filehandler
        error_file_handler = logging.FileHandler(error_log_file_path, mode='w', delay=True)
